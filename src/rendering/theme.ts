...
const VOID_PALETTE = {
  ...
  beam: 0xff4ab9, beamHot: 0xffa2e2, beam2: 0xff248f, beamCore: 0xfff4ff,
  laserBody: 0xff38b7, laserPlasma: 0xff90d4, laserCore: 0xfff4ff, laserMist: 0x944de8,
...
export const THEMES: readonly GameTheme[] = Object.freeze([
  { id: 'void', name: '深空霓虹', tagline: '霓虹 · 能量场', colorScheme: 'dark', colors: palette({}) },
  {
    ...
    colors: palette({
      ...
      beam: 0xff50c9, beamHot: 0xffa7ec, beam2: 0xf52aa9,
      laserBody: 0xff3bc7, laserPlasma: 0xff96e1, laserMist: 0x8053e8,
