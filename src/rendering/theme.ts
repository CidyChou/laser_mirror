...
const VOID_PALETTE = {
  ...
  cellA: 0x24344a, cellB: 0x1d2a3d, cellShade: 0x0b1220,
  ...
  laserPlasma: 0xffcdd9, laserCore: 0xfffdfd,
  ...
  mirrorBlade: 0xa9c9e1, mirrorCore: 0xf9fdff,
...
export const THEMES: readonly GameTheme[] = Object.freeze([
  { id: 'void', name: '深空霓虹', tagline: '冷静 · 精密', colorScheme: 'dark', colors: palette({}) },
  {
    ...
    colors: palette({
      ...
      cellA: 0x32305a, cellB: 0x29274b, cellShade: 0x15142c,
  ...
  },
  {
    ...
    colors: palette({
      ...
      cellA: 0xfff1d9, cellB: 0xf7e3c2, cellShade: 0xd8bd94,
